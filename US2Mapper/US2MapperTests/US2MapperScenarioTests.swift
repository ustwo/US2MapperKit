//
//  US2MapperScenarioTests.swift
//  US2MapperMappingTests
//
...
class US2MapperScenarioTests: XCTestCase {
    ...
    func testArraySimpleSubtypeMapping() {
        ...
        for stringValue in stringArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayStringType!.contains(stringValue) == true, "Array subtype as String was parsed incorrectly from Array")
        }
        
        for doubleValue in doubleArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayDoubleType!.contains(doubleValue) == true, "Array subtype as Double was parsed incorrectly from Array")
        }
        
        for floatValue in floatArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayFloatType!.contains(floatValue) == true, "Array subtype as Float was parsed incorrectly from Array")
        }
        
        for intValue in intArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayIntType!.contains(intValue) == true, "Array subtype as Int was parsed incorrectly from Array")
        }
        
        for stringValue in stringArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayStringType.contains(stringValue) == true, "Non-Optional Array subtype as String was parsed incorrectly from Array")
        }
        
        for doubleValue in doubleArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayDoubleType.contains(doubleValue) == true, "Non-Optional Array subtype as Double was parsed incorrectly from Array")
        }
        
        for floatValue in floatArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayFloatType.contains(floatValue) == true, "Non-Optional Array subtype as Float was parsed incorrectly from Array")
        }
        
        for intValue in intArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayIntType.contains(intValue) == true, "Non-Optional Array subtype as Int was parsed incorrectly from Array")
        }
    }
    ...
    func testArraySimpleSubtypeToArraysOfDictionaries() {
        ...
        for (_ , stringValue) in stringDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayStringType!.contains(stringValue) == true, "Array subtype as String was parsed incorrectly from dictionary")
        }
        
        for (_ , doubleValue) in doubleDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayDoubleType!.contains(doubleValue) == true, "Array subtype as Double was parsed incorrectly from dictionary")
        }
        
        for (_ , floatValue) in floatDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayFloatType!.contains(floatValue) == true, "Array subtype as Float was parsed incorrectly from dictionary")
        }
        
        for (_ , intValue) in intDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayIntType!.contains(intValue) == true, "Array subtype as Int was parsed incorrectly from dictionary")
        }
        
        for (_ , stringValue) in stringDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayStringType.contains(stringValue) == true, "Non-Optional Array subtype as String was parsed incorrectly from dictionary")
        }
        
        for (_ , doubleValue) in doubleDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayDoubleType.contains(doubleValue) == true, "Non-Optional Array subtype as Double was parsed incorrectly from dictionary")
        }
        
        for (_ , floatValue) in floatDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayFloatType.contains(floatValue) == true, "Non-Optional Array subtype as Float was parsed incorrectly from dictionary")
        }
        
        for (_ , intValue) in intDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayIntType.contains(intValue) == true, "Non-Optional Array subtype as Int was parsed incorrectly from dictionary")
        }
    }
