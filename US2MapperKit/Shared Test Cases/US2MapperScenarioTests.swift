...
class US2MapperScenarioTests: XCTestCase {
    ...
    func testArraySimpleSubtypeMapping() {
        ...
        for stringValue in stringArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayStringType!.containsValue(stringValue) == true, "Array subtype as String was parsed incorrectly from Array")
        }
        
        for doubleValue in doubleArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayDoubleType!.containsValue(doubleValue) == true, "Array subtype as Double was parsed incorrectly from Array")
        }
        
        for floatValue in floatArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayFloatType!.containsValue(floatValue) == true, "Array subtype as Float was parsed incorrectly from Array")
        }
        
        for intValue in intArray {
            XCTAssertTrue(testObjectInstance?.optionalArrayIntType!.containsValue(intValue) == true, "Array subtype as Int was parsed incorrectly from Array")
        }
        
        for stringValue in stringArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayStringType.containsValue(stringValue) == true, "Non-Optional Array subtype as String was parsed incorrectly from Array")
        }
        
        for doubleValue in doubleArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayDoubleType.containsValue(doubleValue) == true, "Non-Optional Array subtype as Double was parsed incorrectly from Array")
        }
        
        for floatValue in floatArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayFloatType.containsValue(floatValue) == true, "Non-Optional Array subtype as Float was parsed incorrectly from Array")
        }
        
        for intValue in intArray {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayIntType.containsValue(intValue) == true, "Non-Optional Array subtype as Int was parsed incorrectly from Array")
        }
    }
    ...
    func testArraySimpleSubtypeToArraysOfDictionaries() {
        ...
        for (_ , stringValue) in stringDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayStringType!.containsValue(stringValue) == true, "Array subtype as String was parsed incorrectly from dictionary")
        }
        
        for (_ , doubleValue) in doubleDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayDoubleType!.containsValue(doubleValue) == true, "Array subtype as Double was parsed incorrectly from dictionary")
        }
        
        for (_ , floatValue) in floatDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayFloatType!.containsValue(floatValue) == true, "Array subtype as Float was parsed incorrectly from dictionary")
        }
        
        for (_ , intValue) in intDictionary {
            XCTAssertTrue(testObjectInstance?.optionalArrayIntType!.containsValue(intValue) == true, "Array subtype as Int was parsed incorrectly from dictionary")
        }
        
        for (_ , stringValue) in stringDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayStringType.containsValue(stringValue) == true, "Non-Optional Array subtype as String was parsed incorrectly from dictionary")
        }
        
        for (_ , doubleValue) in doubleDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayDoubleType.containsValue(doubleValue) == true, "Non-Optional Array subtype as Double was parsed incorrectly from dictionary")
        }
        
        for (_ , floatValue) in floatDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayFloatType.containsValue(floatValue) == true, "Non-Optional Array subtype as Float was parsed incorrectly from dictionary")
        }
        
        for (_ , intValue) in intDictionary {
            XCTAssertTrue(testObjectInstance?.non_optionalArrayIntType.containsValue(intValue) == true, "Non-Optional Array subtype as Int was parsed incorrectly from dictionary")
        }
    }
